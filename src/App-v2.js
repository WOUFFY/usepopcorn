...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // console.log(watchedMovie.userRating);
        ...
        <>
          <header>
            ...
            <div className="details-overview">
              ...
              <p>{imdbRating} <span>⭐️</span></p>
            </div>
            {/* <p>Selected Movie ID: {selectedId}</p> */}
          </header>
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>You rated this movie: <strong>{watchedMovie.userRating} ⭐</strong></p>
              )}
            </div>
              <p><em>{plot}</em></p>
